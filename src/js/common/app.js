...
var App = (function() {
  ...
  var handleMaterialDesign = function() {
    ...
    if ($('body').hasClass('page-md')) {
      ...
      $('body').on('click', 'a.btn, button.btn, input.btn, label.btn', function(
        e
      ) {
        element = $(this);
  ...
  var handleiCheck = function() {
    ...
    $('.icheck').each(function() {
      ...
      if (
        checkboxClass.indexOf('_line') > -1 ||
        radioClass.indexOf('_line') > -1
      ) {
        $(this).iCheck({
      ...
      $(el).each(function() {
        if ($(this).attr('data-initialized') === '1') {
          ...
          if ($(this).attr('data-always-visible')) {
            attrList['data-always-visible'] = $(this).attr(
              'data-always-visible'
            );
          }
